...
class StoreProviderRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'email'=>'required|string|max:250|unique:providers',
            'telefono'=>'required|string|max:10|min:8|unique:providers',
            'ruc_number'=>'required|string|max:8|min:8|unique:providers',
