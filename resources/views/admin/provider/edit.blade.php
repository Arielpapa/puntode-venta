            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nombre" id="name" value="{{$provider->nombre}}" aria-describedby="helpId" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="direccion" id="address" value="{{$provider->direccion}}" aria-describedby="helpId" required>
                    </div>

                    <div class="form-group">
                        <label for="phone">Numero de contacto</label>
                        <input type="number" class="form-control" name="telefono" id="phone" value="{{$provider->telefono}}" aria-describedby="helpId" required>
                    </div>
